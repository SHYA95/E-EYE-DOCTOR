...
//
//    // Instantiate the desired view controller from the storyboard
//    if let viewController = storyboard.instantiateViewController(withIdentifier: "YourViewControllerIdentifier") as? HomeViewController {
//        // Set any necessary properties on the view controller
...
//        case 0:
//            print ("done")
//            let eyeTestingVC = EyeTestingHomeVC()
...
class HomeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let borderColor = UIColor(red: 83/255, green: 180/255, blue: 182/255, alpha: 1).cgColor
        let cornerRadius: CGFloat = 10
        
        configureView(view1, borderColor: borderColor, cornerRadius: cornerRadius)
        configureView(view2, borderColor: borderColor, cornerRadius: cornerRadius)
        configureView(view3, borderColor: borderColor, cornerRadius: cornerRadius)
        configureView(view4, borderColor: borderColor, cornerRadius: cornerRadius)
        configureView(view5, borderColor: borderColor, cornerRadius: cornerRadius)
        configureView(view6, borderColor: borderColor, cornerRadius: cornerRadius)
    }
    
    func configureView(_ view: UIView, borderColor: CGColor, cornerRadius: CGFloat) {
    ...
    @IBAction func EyeTest(_ sender: UIButton) {

    }
    
    @IBAction func EEYE(_ sender: UIButton) {
    ...
    @IBAction func EyeCare(_ sender: UIButton) {

    }
    
    @IBAction func EyeRecord(_ sender: UIButton) {
